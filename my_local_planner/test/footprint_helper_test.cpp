...
public:
  ...
  void correctLineCells() {
    std::vector<my_local_planner::Position2DInt> footprint;
  ...
  void correctFootprint(){
    ...
    std::vector<my_local_planner::Position2DInt> footprint = fh.getFootprintCells(pos, footprint_spec, map, false);
